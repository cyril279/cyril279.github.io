...
INKCUTBOX_HOME=$HOME/$CONTAINER_NAME #Path where $HOME of distrobox will be located
...
echo ""
echo "Distrobox definition entry:"
echo ""
echo "$DBX_DEFN_INI"
echo ""
echo "definitial file $CONTAINER_NAME.ini will be written to the following path:"
echo "$INKCUTBOX_HOME/$CONTAINER_NAME.ini"
echo ""
echo "To adjust these values, edit the variable definitions"
echo "'CONTAINER_NAME' & 'INKCUTBOX_HOME' at the beginning of the script"
echo ""
read -p "Are you ready to proceed with the installation as detailed above? (yes/no)" user_input
#
